...
public class HomeController extends Controller {
    ...
    public Result guitars() {
	     return ok(guitars.render(getUserFromSession()));
    }

    public Result drums() {
	     return ok(drums.render(getUserFromSession()));
    }

    public Result keyboards() {
	     return ok(keyboards.render(getUserFromSession()));
    }

    public Result amps() {
	     return ok(amps.render(getUserFromSession()));
    }

    public Result mics() {
	     return ok(mics.render(getUserFromSession()));
    }

    public Result lighting() {
	     return ok(lighting.render(getUserFromSession()));
    }
